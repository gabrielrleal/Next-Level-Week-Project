    ...
    <div id="page-map">
      ...
      >
        ...
        {orphanages.map((orphanage) => {
          //por que não for each? porque o map percorre vai array e retorna algo
          return (
            //não é identificada oque tem dentro do orphanage, pois não se sabe qual o formato de orphanage, para isso, é preciso criar uma interface com as informações de orphanage irão ser utilizadas
            <Marker
              key={orphanage.id}
              icon={mapIcon}
              alt="mapMarker"
